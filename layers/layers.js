var wms_layers = [];
        ...
        var lyr_AutoNaviBaseMap_0 = new ol.layer.Tile({
            'title': 'AutoNavi BaseMap',
            'type': 'base',
            'opacity': 1.000000,
...
lyr_AutoNaviBaseMap_0.setVisible(true);lyr_BingMapsSatelliteImagery_1.setVisible(true);lyr_GoogleSatellite_2.setVisible(true);lyr_OSMStandard_3.setVisible(true);lyr_amphoe_4.setVisible(true);lyr_water_way_5.setVisible(true);lyr_village_6.setVisible(true);
var layersList = [lyr_AutoNaviBaseMap_0,lyr_BingMapsSatelliteImagery_1,lyr_GoogleSatellite_2,lyr_OSMStandard_3,lyr_amphoe_4,lyr_water_way_5,lyr_village_6];
...
lyr_water_way_5.set('fieldImages', {'osm_id': '', 'code': '', 'fclass': '', 'width': '', 'name': '', });
lyr_village_6.set('fieldImages', {'NRD_CODE': '', 'VILL_CODE': '', 'VILL_NAM_T': '', 'PROV_CODE': '', });
lyr_amphoe_4.set('fieldLabels', {'ID': 'no label', 'AMP_CODE': 'no label', 'AMP_TH': 'no label', 'AMP_EN': 'no label', 'PROV_CODE': 'no label', 'PROV_TH': 'no label', 'PROV_EN': 'no label', 'REG_NESDB': 'no label', 'REG_ROYIN': 'no label', 'AREA': 'no label', 'ADMIN_TYPE': 'no label', });
